    ...
    return (
        <>
            <div className='p-5 flex items-center justify-between mt-24'>
                <div className=''>
                    <h1 className='flex gap-3 font-bold text-2xl'>Enrollments</h1>
                ...
                <button className='px-5 py-2  text-sm rounded-xl font-semibold bg-[#1d20db] text-white flex gap-3'><FiDownload size={20} />Export Enrollments</button>
            </div>
            ...
            <div className='mx-5 mt-3 flex gap-8  text-[#63605B]'>
                <div className='shadow-[0_4px_20px_rgba(0,0,0,0.20)]  rounded-xl w-1/4 px-8 py-5' >
                    <div className='flex gap-3 '>
                        <div className='h-12 w-12 flex justify-center items-center bg-[#1d20db]  rounded-full text-white '><FaGraduationCap size={24} /></div>
                ...
                <div className='shadow-[0_4px_20px_rgba(0,0,0,0.20)]  rounded-xl w-1/4 px-8 py-5' >
                    <div className='flex gap-3'>
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <p className='font-bold text-2xl text-black' >890</p>
                ...
                <div className='shadow-[0_4px_20px_rgba(0,0,0,0.20)]  rounded-xl w-1/4 px-8 py-5' >
                    <div className='flex gap-3'>
                        <div className='h-12 w-12 flex justify-center items-center bg-[#F59E0B] rounded-full text-white '><LuNewspaper size={28} /></div>
                        <div className='flex flex-col gap-3'>
                            <p className=''>Complete Courses</p>
                            <p className='font-bold text-2xl text-black' >310</p>
                ...
                <div className='shadow-[0_4px_20px_rgba(0,0,0,0.20)]  rounded-xl w-1/4 px-8 py-5' >
                    <div className='flex gap-3'>
                        <div className='h-12 w-12 flex justify-center items-center  bg-[#6366F1]  rounded-full text-white '><GiSandsOfTime size={28} /></div>
                        <div className='flex flex-col gap-3'>
                            <p className=''>Pending Approvals</p>
                            <p className='font-bold text-2xl text-black' >50</p>
            ...
            <div className=" flex">
                <div className='shadow-[0_4px_20px_rgba(0,0,0,0.20)]  rounded-xl py-5 m-5 px-5 w-[65%]' >
                    ...
                    <table className='w-full mt-5 '>
                        <thead className='bg-[#ddd4d4] '>
                            <tr className='my-5'>
                                ...
                                <th className='py-4 text-left pr-3'>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className='border-b  border-[#d6ccbb]'>
                                ...
                                <td><p className='inline-flex items-center mr-3    text-[#10B981] px-3 py-1 rounded-xl bg-[#8ad2ba]'>Active</p></td>
                                    ...
                                    <p
                                        onClick={() =>
                                            setSelectedMessage({
                                                ...
                                                enrollmentDate: "22 May 2025, 10:30 AM",
                                                paymentStatus: "Paid",
                                                paymentMethod: "Razorpay",
                                                amount: "₹12,999",
                                                transactionId: "pay_KCX3b84I3s92jd",
                                                progress: "75% Completed",
                                                lastAccess: "20 May 2025, 08:45 PM",
                                                certificateStatus: "Not Issued",
                                            })}
                                        className='inline-flex border-2 p-1 mx-3 rounded-lg border-[#e4dfdf] text-[#1d20db] cursor-pointer' ><MdOutlineRemoveRedEye size={20} />
                                    </p>
                                </td>
                            </tr>
                            <tr className='border-b  border-[#d6ccbb]'>
                ...
                {selectedMessage && (
                    <div className="shadow-[0_4px_20px_rgba(0,0,0,0.20)]  rounded-xl py-5 my-5 px-5 w-[30%]">
                        ...
                        <div className="flex items-center justify-between w-full px-2">
                            ...
                            <p className=' bg-[#4749c353]   text-[#1d20db] text-sm rounded-lg bg-[#8ad2ba] h-8 px-3 flex items-center'>Active </p>
                        </div>
                        <div className="flex justify-between mt-5">
                            <div className="text-[#63605B] flex flex-col gap-2">
                                <p>Course: </p>
                                <p>Enrollment Date: </p>
                                <p>Payment status: </p>
                                <p>Payment Method: </p>
                            ...
                            <div className="flex flex-col gap-2 text-black font-bold">
                                <p>{selectedMessage.course}</p>
                                <p>{selectedMessage.enrollmentDate}</p>
                                <p>{selectedMessage.paymentStatus}</p>
                                <p>{selectedMessage.paymentMethod}</p>
                                <p>{selectedMessage.amount}</p>
                                <p>{selectedMessage.transactionId}</p>
                                <p>{selectedMessage.progress}</p>
                                <p>{selectedMessage.lastAccess}</p>
                                <p>{selectedMessage.certificateStatus}</p>
                            </div>
                        </div>

                        <button className='flex justify-center py-2 rounded-xl font-bold text-white border-2 bg-[#1d20db] mt-3  gap-2 w-full '><RiSendPlaneLine className="mt-1" />Send Message</button>
