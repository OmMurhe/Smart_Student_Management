...
const AppDevelopement = () => {
  ...
  <div className='bg-gradient-to-r from-[#2d1db8] to-[#6c3cff] w-full h-90 flex flex-row'>
        <div className=' flex flex-col w-[55%]'>
          ...
          <div className='flex'>
            <div className='h-14 w-14 flex justify-center items-center bg-[#5337E7] rounded-lg ml-24 mt-5 '><LuSmartphone className=' font-bold text-3xl text-yellow-500' /></div>
            <div className='ml-5 flex flex-col gap-3'>
              <div className='w-20 border-1 border-amber-400 h-6 flex justify-center items-center mt-5 rounded-lg bg-[#7462FF] font-bold text-xs text-yellow-400 '>Popular</div>
              <h1 className='text-white font-bold   text-3xl'>App Developement</h1>
              <p className=' mt-1 text-white'> Learn to build powerful and user-friendly mobile applications <br/> for Android and iOS platforms.</p>
              <div className=' flex flex-row gap-5'>
                ...
                <span className='flex gap-2 text-white'><FiUsers className=' mt-1' /><p>15.2K Students</p></span>
                <div className="h-5 w-[1px] bg-white/30 mt-1"></div>
                <span className='flex gap-2 text-white'><LuClock3 className=' mt-1' /><p>10 Weeks</p></span>
                <div className="h-5 w-[1px] bg-white/30 mt-1"></div>
        ...
        <div className='w-full flex mt-5 px-24 py-5  gap-5 z-10 '>
          <div className='w-2/3 shadow-[0_4px_20px_rgba(0,0,0,0.20)] p-6 rounded-2xl '>
            ...
            <p className='mt-3'> This App Development course will take you from the basics to advanced level,<br/> where you will build real-world mobile apps for Android and iOS. You will learn<br/> modern tools, frameworks, and best practices used in the industry.</p>
  
            <div className='flex mt-7'>
              <div className='bg-[#2d1db8] p-2 rounded-full text-white h-10 w-10  mt- justify-center items-center '><LuSmartphone size={24} /></div>
              ...
              <div className='ml-5 text-sm'>
                ...
                <p className='mt-1'>Flutter,Kotlin,Swift,Firebase</p>
              </div>
            ...
            <div className='flex gap-16'>
              <div className='flex flex-col gap-5 mt-3'>
                <div className='flex gap-5'>
                  ...
                  <p>Dart programming fundamentals</p>
                </div>
                <div className='flex gap-5'>
                  <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                  <p>Flutter UI & widget development</p>
                </div>
                <div className='flex gap-5'>
                  <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                  <p>State management (Provider, Bloc)</p>
                </div>
                <div className='flex gap-5'>
                  <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                ...
                <div className='flex gap-5'>
                  <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                  <p>App deployment on App Store</p>
                </div>
              </div>
              ...
              <div>
                <div className='flex flex-col gap-5 mt-3'>
                  ...
                  <div className='flex gap-5'>
                    <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                    <p>App deployment on Play Store</p>
                  </div>
                  <div className='flex gap-5'>
                    <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
              ...
              <div className='flex w-full justify-between items-center'>
               ...
               <div className='bg-[#d9d7e6] rounded-xl p-3'>
                ...
                <div className='flex '>
                 ...
                 <p className='font-bold text-2xl text-[#1E1E2F] '>25,999</p>
                  <span className='ml-5 mt-4 text-xs text-[#7A7A8A]'><FaRupeeSign /></span>
                  <p className='text-xs mt-3 text-[#7A7A8A] line-through'>28,999</p>
                  <div className='px-2 py-1 ml-5 bg-white rounded-xl'><p className='text-[#3B22B8]'>42%OFF</p></div>
                </div>
