   ...
   <>
    <div className='bg-gradient-to-r from-[#2d1db8] to-[#6c3cff] w-full h-90 flex flex-row'>
         <div className=' flex flex-col w-[55%]'>
           ...
           <div className='flex'>
             <div className='h-14 w-14 flex justify-center items-center bg-[#5337E7] rounded-lg ml-24 mt-5 '><LuShieldCheck className=' font-bold text-3xl text-yellow-500' /></div>
             <div className='ml-5 flex flex-col gap-3'>
               ...
               <h1 className='text-white font-bold text-3xl'>Cyber Security</h1>
               <p className=' mt-1 text-white'>Outsmart the hackers. Master Zero Trust, Cloud Security,<br/> and Threat Intelligence to shield enterprises in 2026.</p>
               <div className=' flex flex-row gap-5'>
                 <span className='flex gap-2 text-white'><FaRegStar className='text-yellow-400 mt-1' /><p>4.3</p></span>
                 <div className="h-5 w-[1px] bg-white/30 mt-1"></div>
                 <span className='flex gap-2 text-white'><FiUsers className=' mt-1' /><p>9K+ Students</p></span>
                 <div className="h-5 w-[1px] bg-white/30 mt-1"></div>
                 <span className='flex gap-2 text-white'><LuClock3 className=' mt-1' /><p>8 Weeks</p></span>
                 <div className="h-5 w-[1px] bg-white/30 mt-1"></div>
                 <span className='flex gap-2 text-white'><BsBarChartFill className=' mt-1' /><p>Advanced Track</p></span>
               </div>
         ...
         <div className='w-full flex mt-5 px-24 py-5  gap-5 z-10 '>
           <div className='w-2/3 shadow-[0_4px_20px_rgba(0,0,0,0.20)] p-6 rounded-2xl '>
             ...
             <p className='mt-3'> This Cyber Security course is designed for students and IT professionals who want to learn how to protect systems, networks, and applications from cyber threats. You will gain hands-on experience with ethical hacking, network security, penetration testing, and security tools used in the industry.</p>
             ...
             <div className='flex mt-7'>
               ...
               <div className='ml-5 text-sm '>
                 <p className='text-[#2d1db8] font-bold '>Live Labs</p>
                 <p className='mt-1'>Practice hacking safely</p>
               </div>
               ...
               <div className='ml-5 text-sm'>
                 <p className='text-[#2d1db8] font-bold'>Vulnerability</p>
                 <p className='mt-1'>Real-world exploit kits</p>
               </div>
               ...
               <div className='ml-5 text-sm'>
                 <p className='text-[#2d1db8] font-bold'>Career Ready</p>
                 <p className='mt-1'>Resume & SOC Prep</p>
               </div>
             </div>
             ...
             <div className='flex gap-16'>
               <div className='flex flex-col gap-5 mt-3'>
                 ...
                 <div className='flex gap-5'>
                   <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                   <p>Ethical hacking concepts</p>
                 </div>
                 <div className='flex gap-5'>
                   <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                   <p>Network security techniques</p>
                 </div>
                 <div className='flex gap-5'>
                   <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                   <p>Penetration testing basics</p>
                 </div>
                  <div className='flex gap-5'>
                   <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
               ...
               <div>
                 <div className='flex flex-col gap-5 mt-3'>
                   <div className='flex gap-5'>
                     <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                     <p>Password cracking & encryption</p>
                   </div>
                   <div className='flex gap-5'>
                     <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                   ...
                   <div className='flex gap-5'>
                     <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                     <p>Malware and phishing protection</p>
                   </div>
                   <div className='flex gap-5'>
                     <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                     <p>Firewall and system security</p>
                   </div>
                   <div className='flex gap-5'>
                     <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                     <p>Real-world cyber attack prevention</p>
                   </div>
                 </div>
               </div>
             </div>
               ...
               <div className='flex w-full justify-between items-center'>
                ...
                <div className='bg-[#d9d7e6] rounded-xl p-3'>
                 ...
                 <div className='flex '>
                  ...
                  <p className='font-bold text-2xl text-[#1E1E2F] '>50,999</p>
                   <span className='ml-5 mt-4 text-xs text-[#7A7A8A]'><FaRupeeSign /></span>
                   <p className='text-xs mt-3 text-[#7A7A8A] line-through'>53.999</p>
                   <div className='px-2 py-1 ml-5 bg-white rounded-xl'><p className='text-[#3B22B8]'>28%OFF</p></div>
                 </div>
