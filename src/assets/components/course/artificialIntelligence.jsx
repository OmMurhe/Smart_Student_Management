   ...
   <>
    <div className='bg-gradient-to-r from-[#2d1db8] to-[#6c3cff] w-full h-90 flex flex-row'>
         <div className=' flex flex-col w-[55%]'>
           ...
           <div className='flex'>
             <div className='h-14 w-14 flex justify-center items-center bg-[#5337E7] rounded-lg ml-24 mt-5 '><LuBrainCircuit className=' font-bold text-3xl text-yellow-500' /></div>
             <div className='ml-5 flex flex-col gap-3'>
               <div className='w-20 border-1 border-amber-400 h-6 flex justify-center items-center mt-5 rounded-lg bg-[#7462FF] font-bold text-xs text-yellow-400 '>New Launch</div>
               <h1 className='text-white font-bold text-3xl'>Artificial Intelligence</h1>
               <p className=' mt-1 text-white'>Step into the future. Master Generative AI, Prompt Engineering, <br/>and Neural Networks to build intelligent agents and <br/>autonomous systems.</p>
               <div className=' flex flex-row gap-5'>
                 ...
                 <span className='flex gap-2 text-white'><FiUsers className=' mt-1' /><p>3.2K Students</p></span>
                 <div className="h-5 w-[1px] bg-white/30 mt-1"></div>
                 <span className='flex gap-2 text-white'><LuClock3 className=' mt-1' /><p>14 Weeks</p></span>
                 <div className="h-5 w-[1px] bg-white/30 mt-1"></div>
                 <span className='flex gap-2 text-white'><BsBarChartFill className=' mt-1' /><p>Specialized Track</p></span>
               </div>
         ...
         <div className='w-full flex mt-5 px-24 py-5  gap-5 z-10 '>
           <div className='w-2/3 shadow-[0_4px_20px_rgba(0,0,0,0.20)] p-6 rounded-2xl '>
             ...
             <p className='mt-3'>This Artificial Intelligence course is designed for students and professionals who want to build intelligent systems using modern AI technologies. You will learn machine learning, deep learning, neural networks, computer vision, and AI model development through hands-on projects and real-world applications.</p>
             ...
             <div className='flex mt-7'>
               ...
               <div className='ml-5 text-sm '>
                 <p className='text-[#2d1db8] font-bold '>Generative AI</p>
                 <p className='mt-1'>LLMs & Agents</p>
               </div>
               ...
               <div className='ml-5 text-sm'>
                 <p className='text-[#2d1db8] font-bold'>Deep Learning</p>
                 <p className='mt-1'>Complex Neural Nets</p>
               </div>
               ...
               <div className='ml-5 text-sm'>
                 <p className='text-[#2d1db8] font-bold'>Industry Cert</p>
                 <p className='mt-1'>Career-ready skill</p>
               </div>
             </div>
             ...
             <div className='flex gap-16'>
               ...
               <div>
                 <div className='flex flex-col gap-5 mt-3'>
                   ...
                   <div className='flex gap-5'>
                     <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                     <p>AI project deployment</p>
                   </div>
                   <div className='flex gap-5'>
                     <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                     <p>Real-world AI applications</p>
                   </div>
                   <div className='flex gap-5'>
                     <div className='bg-[#2d1db8] mt-1  rounded-full text-white h-5 w-5 flex justify-center items-center text-xs'><FaCheck /></div>
                     <p>Building intelligent automation systems</p>
                   </div>
                 </div>
               </div>
             </div>
               ...
               <div className='flex w-full justify-between items-center'>
                ...
                <div className='bg-[#d9d7e6] rounded-xl p-3'>
                 ...
                 <div className='flex '>
                  ...
                  <p className='font-bold text-2xl text-[#1E1E2F] '>38,999</p>
                   <span className='ml-5 mt-4 text-xs text-[#7A7A8A]'><FaRupeeSign /></span>
                   <p className='text-xs mt-3 text-[#7A7A8A] line-through'>41,999</p>
