...
import { FaGraduationCap, FaUserTie, FaBookOpen, FaAward, FaStar } from "react-icons/fa";
    ...
    return (
        <>
            <div className="w-full h-[500px] bg-cover bg-center flex z-5"
                ...
                <div className='pt-12 pl-24 w-1/2 '>
                    ...
                    <div className='flex gap-5'>
                        ...
                        <button className='px-4 py-2 rounded-xl mt-4 font-bold text-white border-2'onClick={()=>navigate('/course')}>View All Course →</button>
                    </div>
                    <div className='mt-5  flex'>
                        <div className='h-16 w-16  rounded-full'><img src={Aliya} alt='Miya' className='h-full w-full rounded-full' /></div>
                        <div className='h-16 w-16  rounded-full relative right-4'><img src={Nora} alt='Miya' className='h-full w-full rounded-full' /></div>
                        <div className='h-16 w-16 rounded-full relative right-8'><img src={Dipika} alt='Miya' className='h-full w-full rounded-full' /></div>
                        <div className='h-16 w-16  rounded-full relative right-12'><img src={Kiyara} alt='Miya' className='h-full w-full rounded-full' /></div>
            ...
            <div className='w-[90%] mx-auto '>
              ...
              <p className='text-purple-800 font-bold mt-5'>Success Stories</p>
                <div className='flex justify-between items-center'>
                    <h1 className='text-3xl  font-bold'>What Our Student Say</h1>
                    <span className='text-purple-800 font-bold  ml-auto' onClick={() => navigate('/successStories')}>View All Stories→</span>
                </div>
                <div className='mx-10 mt-5'>
                    <div className='mt-5 flex gap-5 '>
                        <div className='w-112 rounded-2xl  h-80 shadow-[0_4px_20px_rgba(0,0,0,0.20)] flex '>
                        ...
                        {/*card 2*/}
                        <div className='w-112 rounded-2xl  shadow-[0_4px_20px_rgba(0,0,0,0.20)] flex h-80'>
